...
<html lang="en">
  ...
  <body>
    <center><h1>Pencatatan Buku</h1>
    <a href="/tambah" type="button" class="btn btn-primary">Tambah Buku</a></center><br><br>
    <div class="container">
        <div class="row">
    <table class="table table-dark table-striped">
        <thead>
            <tr>
              ...
              <th scope="col-lg-3">Judul</th>
              <th scope="col-lg-3">Author</th>
              <th scope="col-lg-3">Synopsis</th>
              <th scope="col-lg-3">Penerbit</th>
